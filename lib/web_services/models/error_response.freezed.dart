...
class _$ErrorResponseImpl implements _ErrorResponse {
  const _$ErrorResponseImpl(
      {this.code, this.name, this.message, this.details, this.stack});
  ...
  @override
  String toString() {
    return 'ErrorResponse(code: $code, name: $name, message: $message, details: $details, stack: $stack)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, code, name, message, details, stack);
...
abstract class _ErrorResponse implements ErrorResponse {
  const factory _ErrorResponse(
      ...
      final String? message,
      final Details? details,
      final String? stack}) = _$ErrorResponseImpl;
