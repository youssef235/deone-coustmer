import 'package:wasq/web_services/web_services.dart';
...
abstract class AuthRepository {
  ...
  Future<User?> otpVerify(
      {required String phone, required String code, required int temp_user_id});
  Future<int> register(
...
class AuthRepositoryImpl implements AuthRepository {
  ...
  Future<User?> otpVerify({
    ...
    try {
      ...
      var response = await HttpClient.dio.post(
        isLogin ? EndPoints.otpLogin : EndPoints.otpRegister,
        data: data,
        options: Options(headers: {
          "Accept": "application/json",
        }),
