...
mixin _$InvoiceState {
  ...
  String get selectedPaymentString => throw _privateConstructorUsedError;
...
class _$InvoiceStateCopyWithImpl<$Res, $Val extends InvoiceState>
  ...
  $Res call({
    ...
    Object? selectedPaymentString = null,
  }) {
    return _then(_value.copyWith(
      ...
      errorMessage: null == errorMessage
          ...
          : errorMessage // ignore: cast_nullable_to_non_nullable
              as String,
      selectedPaymentString: null == selectedPaymentString
          ? _value.selectedPaymentString
          : selectedPaymentString // ignore: cast_nullable_to_non_nullable
              as String,
    ) as $Val);
  }
}
...
class _$InvoiceStateImpl implements _InvoiceState {
  ...
  @override
  @JsonKey()
  final String selectedPaymentString;

  @override
  String toString() {
    return 'InvoiceState(invoiceResponse: $invoiceResponse, loading: $loading, addLoading: $addLoading, add: $add, errorMessage: $errorMessage, selectedPaymentString: $selectedPaymentString)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.selectedPaymentString, selectedPaymentString) ||
                other.selectedPaymentString == selectedPaymentString));
  }

  @override
  int get hashCode => Object.hash(runtimeType, invoiceResponse, loading,
      addLoading, add, errorMessage, selectedPaymentString);
...
abstract class _InvoiceState implements InvoiceState {
  const factory _InvoiceState(
      ...
      final String add,
      final String errorMessage,
      final String selectedPaymentString}) = _$InvoiceStateImpl;
  ...
  @override
  String get selectedPaymentString;
  @override
  @JsonKey(ignore: true)
  _$$InvoiceStateImplCopyWith<_$InvoiceStateImpl> get copyWith =>
      throw _privateConstructorUsedError;
