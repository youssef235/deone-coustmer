...
class AppColors {
  ...
  static const Color primaryColor = Color(0xFFFF8D47);
  ...
  static const Color grayBackground = Color(0xFFFAFAFA); //e7ebee
  static const Color grayBackground2 = Color(0xFFe7ebee); //e7ebee
